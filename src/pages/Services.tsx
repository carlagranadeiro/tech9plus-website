  ...
  const services = [
    {
      ...
      icon: Settings,
      title: 'CNC',
      subtitle: lang === 'pt' ? 'Corte e Maquinação de Precisão' : 'Precision Milling and Machining',
      description: lang === 'pt' ? 'Serviços completos de maquinação CNC para madeira, MDF, acrílico e alumínio. Garantimos precisão e acabamento profissional.' : 'Complete CNC machining services for wood, MDF, acrylic and aluminum. We guarantee precision and professional finishing.',
      image: `${import.meta.env.BASE_URL}real-cnc-sinalizacao.jpg`,
      video: `${import.meta.env.BASE_URL}video-cnc.mp4`,
      features: lang === 'pt' ? ['Corte 3D', 'Corte preciso', 'Maquinação de alumínio'] : ['3D Milling', 'Precise cutting', 'Aluminum machining'],
