  ...
  const services = [
    {
      ...
      icon: Settings,
      title: 'CNC',
      subtitle: lang === 'pt' ? 'Corte de Precisão' : 'Precision Cutting',
      description: lang === 'pt' ? 'Serviços completos de corte CNC para madeira, MDF, acrílico e alumínio. Garantimos precisão e acabamento profissional.' : 'Complete CNC cutting services for wood, MDF, acrylic and aluminum. We guarantee precision and professional finishing.',
      image: `${import.meta.env.BASE_URL}real-cnc-sinalizacao.jpg`,
      video: `${import.meta.env.BASE_URL}video-cnc.mp4`,
      features: lang === 'pt' ? ['Corte 3D', 'Corte de alumínio'] : ['3D Cutting', 'Aluminum cutting'],
    ...
    },
    {
      ...
      subtitle: lang === 'pt' ? 'Corte Limpo e Preciso' : 'Clean and Precise Cuts',
    ...
    },
    {
      ...
      subtitle: lang === 'pt' ? 'Gravação Duradoura' : 'Durable Engraving',
